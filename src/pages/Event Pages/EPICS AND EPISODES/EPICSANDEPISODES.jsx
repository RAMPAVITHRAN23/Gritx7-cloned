            ...
            <div className="relative flex flex-col min-h-screen bg-gray-900 pb-4">
                ...
                <div className="relative z-20 w-[95%] p-5 lg:w-[89%] mt-10 bg-blue-100 lg:p-8 rounded-lg shadow-md lg:max-h-[87vh] lg:overflow-y-auto mx-auto">
                    ...
                    <div className="mt-6 text-justify">
                        <p>
                            📚✨🎬 Get ready for an unforgettable experience where the magic of books, the thrill
                            of series, and the excitement of TV channels come together! Immerse yourself in captivating
                            novels that transport you to other worlds, binge-watch the latest and greatest shows that
                            everyone’s talking about, and explore top TV channels offering endless entertainment. Whether
                            you're a passionate reader, a dedicated series binge-watcher, or a TV enthusiast, our event has
                            something special for you. Join us and let your imagination soar with stories, shows, and
                            channels that will keep you entertained and inspired! 🎉�
                        </p>
                    </div>
