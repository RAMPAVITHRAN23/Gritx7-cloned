            ...
            <div className="relative flex flex-col min-h-screen bg-gray-900 pb-4">
                ...
                <div className="relative z-20 w-[95%] p-5 lg:w-[89%] mt-10 bg-blue-100 lg:p-8 rounded-lg shadow-md lg:max-h-[87vh] lg:overflow-y-auto mx-auto">
                    ...
                    <div className="mt-6 text-justify">
                        <p>
                            PitchXPerfect is a business pitch event designed to spotlight innovative ideas
                            in the digital space 🎨💡. Participants are invited to present their concepts with precision,
                            showcasing their vision and strategy down to the finest detail. This event is an opportunity for
                            aspiring entrepreneurs to impress everyone with their creativity and business acumen.Whether
                            you're refining an existing idea or pitching a brand-new concept, PitchXPerfect is the platform to
                            bring your vision to life and make every pitch count. 🚀✨
