    ...
    return (
        <>
            <div className="relative flex flex-col min-h-screen bg-gray-900 pb-4">
                ...
                {/* Content Container */}
                <div className="relative z-20 w-[89%] mt-10 bg-blue-100 p-8 rounded-lg shadow-md lg:max-h-[87vh] lg:overflow-y-auto mx-auto">
                    <div className="flex flex-col lg:flex-row justify-between items-center">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-center">
                            <div className="text-center">
                                <h1 className="text-4xl lg:text-6xl font-bold mb-4">Echo Fest</h1>
                    ...
                    <div className="flex justify-center mt-6">
                        <div className="bg-blue-500 w-full md:w-1/2 text-white p-4 rounded-lg grid grid-cols-3 grid-rows-2 gap-4 md:grid-cols-5 md:grid-rows-1 md:gap-6">
                    ...
                    <div className="mt-8 text-center">
                        <h2 className="text-2xl font-bold mb-4">CO-ORDINATORS</h2>
                        <div className="space-y-2">
                            <p>1. Ram Pavithran - 8946432323</p>
                            <p>2. Faizal - 1654214454</p>
                            <p>3. Srinesh - 2314546178</p>
                        </div>
                    </div>
                </div>
            </div>
