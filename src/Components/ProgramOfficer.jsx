...
const ProgramOfficer = ({ name, phoneNumber, imageUrl, linkedinUrl }) => {
    return (
        <div className="relative w-56 h-72 mx-auto overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 group">
            <img
                src={imageUrl}
                alt={name}
